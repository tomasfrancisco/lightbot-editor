...
export interface FetchUnknownTriggersResult
  extends QueryResult<FetchUnknownTriggersData> {}

export const fetchUnknownTriggers = graphql<
  ImproveViewProps,
  FetchUnknownTriggersResult,
  {},
  {}
