...
export const steps: Step[] = [
  ...
  {
    target: `#${ElementIdsEnum.SIDE_MENU}`,
    content:
  ...
  {
    target: `#${ElementIdsEnum.INTENT_LIST}`,
    content:
  ...
  {
    target: `#${ElementIdsEnum.WELCOME_INTENT}`,
  ...
  {
    target: `#${ElementIdsEnum.INTENT_EDITOR_OUTPUTS}`,
    content:
